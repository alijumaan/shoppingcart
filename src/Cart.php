...
namespace Alijumaan\Shoppingcart;
...
use Alijumaan\Shoppingcart\Exceptions\UnknownModelException;
use Alijumaan\Shoppingcart\Exceptions\InvalidRowIDException;
use Alijumaan\Shoppingcart\Exceptions\CartAlreadyStoredException;
...
class Cart
{
     ...
     * @param float     $price
     * @param array     $options
     * @return CartItem|CartItem[]|array
     */
     ...
     * Add an item to the cart.
     *
     * @param \Alijumaan\Shoppingcart\CartItem $item          Item to add to the Cart
     * @param bool                              $keepDiscount  Keep the discount rate of the Item
     * @param bool                              $keepTax       Keep the Tax rate of the Item
     * @param bool                              $dispatchEvent
     *
     * @return \Alijumaan\Shoppingcart\CartItem The CartItem
     */
