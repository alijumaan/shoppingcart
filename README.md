...
A simple shopping cart implementation for Laravel 8 & 9 & 10.
...
Run the Composer require command from the Terminal:
    ...
    composer require alijumaan/shoppingcart
...
And optionally add a new line to the `aliases` array:
	...
	'Cart' => Alijumaan\Shoppingcart\Facades\Cart::class,
...
<table>
   	...
   	<tfoot>
		...
		<tr>
			...
			<td><?php echo Cart::getCost(\Alijumaan\Shoppingcart\Cart::COST_TRANSACTION); ?></td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
			<td>Transaction cost</td>
			<td><?php echo Cart::getCost(\Alijumaan\Shoppingcart\Cart::COST_SHIPPING); ?></td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
			<td>Transaction cost</td>
